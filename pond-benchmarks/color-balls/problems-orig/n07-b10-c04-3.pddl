(define (problem n7-b10-c4)
    ...
    (:hidden
        ...
        (ball-pos b2 p3 p6) (ball-color b2 c1)
        (ball-pos b3 p7 p2) (ball-color b3 c1)
        (ball-pos b4 p2 p7) (ball-color b4 c1)
        (ball-pos b5 p1 p1) (ball-color b5 c2)
        (ball-pos b6 p5 p4) (ball-color b6 c2)
        (ball-pos b7 p2 p5) (ball-color b7 c2)
        (ball-pos b8 p5 p3) (ball-color b8 c2)
        (ball-pos b9 p4 p1) (ball-color b9 c2)
        (ball-pos b10 p3 p3) (ball-color b10 c4)
    )
