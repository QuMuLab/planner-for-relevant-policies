(define (problem n5-b8-c4)
    ...
    (:hidden
        (ball-pos b1 p1 p3) (ball-color b1 c1)
        (ball-pos b2 p4 p4) (ball-color b2 c1)
        (ball-pos b3 p1 p4) (ball-color b3 c1)
        (ball-pos b4 p4 p5) (ball-color b4 c3)
        (ball-pos b5 p4 p1) (ball-color b5 c4)
        (ball-pos b6 p3 p5) (ball-color b6 c4)
        (ball-pos b7 p3 p5) (ball-color b7 c4)
        (ball-pos b8 p5 p3) (ball-color b8 c4)
    )
