(define (problem n5-b7-c4)
    ...
    (:hidden
        ...
        (ball-pos b2 p3 p1) (ball-color b2 c2)
        (ball-pos b3 p5 p4) (ball-color b3 c2)
        (ball-pos b4 p5 p2) (ball-color b4 c2)
        (ball-pos b5 p1 p4) (ball-color b5 c3)
        (ball-pos b6 p2 p5) (ball-color b6 c3)
        (ball-pos b7 p1 p2) (ball-color b7 c4)
    )
