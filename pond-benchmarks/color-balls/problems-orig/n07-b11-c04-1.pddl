(define (problem n7-b11-c4)
    ...
    (:hidden
        (ball-pos b1 p2 p4) (ball-color b1 c1)
        (ball-pos b2 p2 p2) (ball-color b2 c1)
        ...
        (ball-pos b7 p5 p6) (ball-color b7 c1)
        (ball-pos b8 p7 p1) (ball-color b8 c1)
        (ball-pos b9 p2 p3) (ball-color b9 c1)
        (ball-pos b10 p2 p2) (ball-color b10 c4)
        (ball-pos b11 p7 p6) (ball-color b11 c4)
    )
    (:goal (and (ball-at-spot b1) (ball-at-spot b2) (ball-at-spot b3) (ball-at-spot b4) (ball-at-spot b5) (ball-at-spot b6) (ball-at-spot b7) (ball-at-spot b8) (ball-at-spot b9) (ball-at-spot b10) (ball-at-spot b11)))
)
