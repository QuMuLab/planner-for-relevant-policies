(define (problem n5-b7-c4)
    ...
    (:hidden
        ...
        (ball-pos b3 p2 p2) (ball-color b3 c1)
        (ball-pos b4 p3 p5) (ball-color b4 c1)
        (ball-pos b5 p3 p1) (ball-color b5 c1)
        (ball-pos b6 p1 p2) (ball-color b6 c2)
        (ball-pos b7 p2 p3) (ball-color b7 c4)
    )
