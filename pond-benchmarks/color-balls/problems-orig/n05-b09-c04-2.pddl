(define (problem n5-b9-c4)
    ...
    (:init
        ...
        (invariant (ball-at-spot b8)
                   (ball-pos b8 p1 p1) (ball-pos b8 p1 p2) (ball-pos b8 p1 p3) (ball-pos b8 p1 p4) (ball-pos b8 p1 p5)
                   (ball-pos b8 p2 p1) (ball-pos b8 p2 p2) (ball-pos b8 p2 p3) (ball-pos b8 p2 p4) (ball-pos b8 p2 p5)
                   (ball-pos b8 p3 p1) (ball-pos b8 p3 p2) (ball-pos b8 p3 p3) (ball-pos b8 p3 p4) (ball-pos b8 p3 p5)
                   (ball-pos b8 p4 p1) (ball-pos b8 p4 p2) (ball-pos b8 p4 p3) (ball-pos b8 p4 p4) (ball-pos b8 p4 p5)
                   (ball-pos b8 p5 p1) (ball-pos b8 p5 p2) (ball-pos b8 p5 p3) (ball-pos b8 p5 p4) (ball-pos b8 p5 p5))
        (invariant (ball-at-spot b9)
                   (ball-pos b9 p1 p1) (ball-pos b9 p1 p2) (ball-pos b9 p1 p3) (ball-pos b9 p1 p4) (ball-pos b9 p1 p5)
                   (ball-pos b9 p2 p1) (ball-pos b9 p2 p2) (ball-pos b9 p2 p3) (ball-pos b9 p2 p4) (ball-pos b9 p2 p5)
                   (ball-pos b9 p3 p1) (ball-pos b9 p3 p2) (ball-pos b9 p3 p3) (ball-pos b9 p3 p4) (ball-pos b9 p3 p5)
                   (ball-pos b9 p4 p1) (ball-pos b9 p4 p2) (ball-pos b9 p4 p3) (ball-pos b9 p4 p4) (ball-pos b9 p4 p5)
                   (ball-pos b9 p5 p1) (ball-pos b9 p5 p2) (ball-pos b9 p5 p3) (ball-pos b9 p5 p4) (ball-pos b9 p5 p5))
    )
    (:hidden
        (ball-pos b1 p3 p5) (ball-color b1 c1)
        (ball-pos b2 p5 p5) (ball-color b2 c1)
        (ball-pos b3 p3 p3) (ball-color b3 c1)
        (ball-pos b4 p5 p5) (ball-color b4 c1)
        (ball-pos b5 p3 p3) (ball-color b5 c2)
        (ball-pos b6 p2 p5) (ball-color b6 c4)
        (ball-pos b7 p5 p2) (ball-color b7 c4)
        (ball-pos b8 p1 p4) (ball-color b8 c4)
        (ball-pos b9 p2 p5) (ball-color b9 c4)
    )
    (:goal (and (ball-at-spot b1) (ball-at-spot b2) (ball-at-spot b3) (ball-at-spot b4) (ball-at-spot b5) (ball-at-spot b6) (ball-at-spot b7) (ball-at-spot b8) (ball-at-spot b9)))
)
