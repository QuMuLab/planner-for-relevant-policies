(define (problem n5-b6-c4)
    ...
    (:hidden
        ...
        (ball-pos b2 p5 p3) (ball-color b2 c2)
        (ball-pos b3 p2 p2) (ball-color b3 c2)
        (ball-pos b4 p2 p3) (ball-color b4 c2)
        (ball-pos b5 p1 p4) (ball-color b5 c4)
        (ball-pos b6 p1 p2) (ball-color b6 c4)
    )
    (:goal (and (ball-at-spot b1) (ball-at-spot b2) (ball-at-spot b3) (ball-at-spot b4) (ball-at-spot b5) (ball-at-spot b6)))
)
