(define (problem n7-b10-c4)
    ...
    (:hidden
        ...
        (ball-pos b2 p1 p5) (ball-color b2 c1)
        (ball-pos b3 p3 p6) (ball-color b3 c1)
        (ball-pos b4 p5 p4) (ball-color b4 c2)
        (ball-pos b5 p7 p3) (ball-color b5 c2)
        (ball-pos b6 p4 p2) (ball-color b6 c4)
        (ball-pos b7 p5 p4) (ball-color b7 c4)
        (ball-pos b8 p2 p5) (ball-color b8 c4)
        (ball-pos b9 p5 p5) (ball-color b9 c4)
