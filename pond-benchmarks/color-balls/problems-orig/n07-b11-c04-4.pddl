(define (problem n7-b11-c4)
    ...
    (:hidden
        (ball-pos b1 p1 p6) (ball-color b1 c1)
        (ball-pos b2 p3 p4) (ball-color b2 c1)
        (ball-pos b3 p4 p2) (ball-color b3 c1)
        (ball-pos b4 p1 p4) (ball-color b4 c1)
        (ball-pos b5 p4 p4) (ball-color b5 c1)
        (ball-pos b6 p5 p1) (ball-color b6 c1)
        (ball-pos b7 p6 p3) (ball-color b7 c1)
        (ball-pos b8 p4 p1) (ball-color b8 c1)
        (ball-pos b9 p5 p1) (ball-color b9 c2)
        (ball-pos b10 p1 p1) (ball-color b10 c3)
        (ball-pos b11 p2 p6) (ball-color b11 c4)
    )
