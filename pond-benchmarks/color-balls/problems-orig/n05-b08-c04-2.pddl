(define (problem n5-b8-c4)
    ...
    (:hidden
        (ball-pos b1 p2 p3) (ball-color b1 c1)
        (ball-pos b2 p2 p2) (ball-color b2 c2)
        (ball-pos b3 p5 p2) (ball-color b3 c2)
        (ball-pos b4 p2 p2) (ball-color b4 c2)
        (ball-pos b5 p4 p5) (ball-color b5 c2)
        (ball-pos b6 p1 p3) (ball-color b6 c4)
        (ball-pos b7 p5 p5) (ball-color b7 c4)
        (ball-pos b8 p4 p4) (ball-color b8 c4)
    )
