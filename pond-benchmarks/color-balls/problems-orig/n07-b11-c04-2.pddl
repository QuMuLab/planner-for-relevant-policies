(define (problem n7-b11-c4)
    ...
    (:hidden
        ...
        (ball-pos b2 p5 p2) (ball-color b2 c1)
        (ball-pos b3 p6 p4) (ball-color b3 c1)
        (ball-pos b4 p5 p3) (ball-color b4 c1)
        (ball-pos b5 p7 p3) (ball-color b5 c1)
        (ball-pos b6 p3 p3) (ball-color b6 c1)
        (ball-pos b7 p4 p6) (ball-color b7 c1)
        (ball-pos b8 p3 p2) (ball-color b8 c1)
        (ball-pos b9 p3 p4) (ball-color b9 c2)
        (ball-pos b10 p4 p7) (ball-color b10 c4)
