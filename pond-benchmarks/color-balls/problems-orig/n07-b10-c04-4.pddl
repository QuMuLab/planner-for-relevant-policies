(define (problem n7-b10-c4)
    ...
    (:hidden
        ...
        (ball-pos b3 p6 p5) (ball-color b3 c2)
        (ball-pos b4 p7 p4) (ball-color b4 c2)
        (ball-pos b5 p2 p5) (ball-color b5 c2)
        (ball-pos b6 p5 p6) (ball-color b6 c2)
        (ball-pos b7 p5 p7) (ball-color b7 c3)
        (ball-pos b8 p6 p5) (ball-color b8 c3)
        (ball-pos b9 p2 p1) (ball-color b9 c4)
        (ball-pos b10 p1 p2) (ball-color b10 c4)
    )
