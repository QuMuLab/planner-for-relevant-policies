(define (problem n7-b11-c4)
    ...
    (:hidden
        ...
        (ball-pos b3 p1 p6) (ball-color b3 c3)
        (ball-pos b4 p2 p7) (ball-color b4 c3)
        (ball-pos b5 p6 p2) (ball-color b5 c3)
        (ball-pos b6 p2 p1) (ball-color b6 c4)
        (ball-pos b7 p1 p3) (ball-color b7 c4)
        (ball-pos b8 p7 p6) (ball-color b8 c4)
        (ball-pos b9 p6 p6) (ball-color b9 c4)
        (ball-pos b10 p6 p3) (ball-color b10 c4)
        (ball-pos b11 p1 p6) (ball-color b11 c4)
    )
