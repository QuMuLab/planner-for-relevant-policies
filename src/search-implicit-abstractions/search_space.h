...
public:
    ...
    __gnu_cxx::hash_map<StateProxy, SearchNodeInfo>::const_iterator begin() const;
    __gnu_cxx::hash_map<StateProxy, SearchNodeInfo>::const_iterator end() const;
};
