...
bool g_replan_during_simulation = false; // True if we want to allow the system to replan
...
bool g_repeat_fsap_backwards = true; // Keep making FSAPs as long as states where they hold have no applicable actions
