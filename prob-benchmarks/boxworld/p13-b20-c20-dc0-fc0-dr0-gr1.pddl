...
(define
 (problem box-p13)
  ...
  (:goal (and
            (box-at-city box0 city16)
            (box-at-city box1 city6)
            (box-at-city box2 city18)
            (box-at-city box3 city15)
            (box-at-city box4 city7)
            (box-at-city box5 city1)
            (box-at-city box6 city16)
            (box-at-city box7 city11)
            (box-at-city box8 city17)
            (box-at-city box9 city6)
            (box-at-city box10 city0)
            (box-at-city box11 city19)
            (box-at-city box12 city3)
            (box-at-city box13 city2)
            (box-at-city box14 city1)
            (box-at-city box15 city6)
            (box-at-city box16 city11)
            (box-at-city box17 city1)
            (box-at-city box18 city6)
            (box-at-city box19 city10)
    )
  )
)
