(define (problem FR_10_5)
 ...
 (:goal (and  (nfire l4) (nfire l6) (nfire l9) (nfire l3) (nfire l3)  (victim-status v1 healthy) (victim-status v2 healthy) (victim-status v3 healthy) (victim-status v4 healthy) (victim-status v5 healthy)))
 )
