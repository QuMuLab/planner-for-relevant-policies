(define (problem FR_5_10)
 ...
 (:goal (and  (nfire l1) (nfire l2) (nfire l4) (nfire l5) (nfire l5) (nfire l4) (nfire l3) (nfire l5) (nfire l5) (nfire l5)  (victim-status v1 healthy) (victim-status v2 healthy) (victim-status v3 healthy) (victim-status v4 healthy) (victim-status v5 healthy) (victim-status v6 healthy) (victim-status v7 healthy) (victim-status v8 healthy) (victim-status v9 healthy) (victim-status v10 healthy)))
 )
