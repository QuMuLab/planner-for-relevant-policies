(define
    ...
    (:types status fire_unit medical_unit location victim)
    (:predicates 
        (fire ?l - location)
        (nfire ?l - location)
        ...
        (Occ1_unload-fire-unit ?u - fire_unit ?l - location ?l1 - location)
        (Occ2_unload-fire-unit ?u - fire_unit ?l - location ?l1 - location)
        (Occ1_treat-victim-on-scene-medical ?u - medical_unit ?l - location ?v - victim)
        (Occ2_treat-victim-on-scene-medical ?u - medical_unit ?l - location ?v - victim)
        (Occ1_treat-victim-on-scene-fire ?u - fire_unit ?l - location ?v - victim)
        (Occ2_treat-victim-on-scene-fire ?u - fire_unit ?l - location ?v - victim)
    )
    ...
    (:action treat-victim-on-scene-medical
        ...
        :precondition
            (and
                ...
                (not
                    (Occ2_treat-victim-on-scene-medical ?u ?l ?v)
                )
            )
        :effect
            (and
                ...
                (Occ1_treat-victim-on-scene-medical ?u ?l ?v)
                (when
                    (Occ1_treat-victim-on-scene-medical ?u ?l ?v)
                    (Occ2_treat-victim-on-scene-medical ?u ?l ?v)
                )
    ...
    (:action treat-victim-on-scene-fire
        ...
        :precondition
            (and
                ...
                (victim-status ?v hurt)
                (not
                    (Occ2_treat-victim-on-scene-fire ?u ?l ?v)
                )
            )
        :effect
            (and
                ...
                (Occ1_treat-victim-on-scene-fire ?u ?l ?v)
                (when
                    (Occ1_treat-victim-on-scene-fire ?u ?l ?v)
                    (Occ2_treat-victim-on-scene-fire ?u ?l ?v)
                )
