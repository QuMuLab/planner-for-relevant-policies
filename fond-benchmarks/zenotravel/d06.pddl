(define (domain zenotravel)
  ...
  (:constants p0 p1 p2 p3 p4 - person)
  ...
  (:action start-flying
    ...
    :precondition (and (at-aircraft ?a ?c1) (fuel-level ?a ?l1) (next ?l2 ?l1) (not-refueling ?a)
                       (not-boarding p0) (not-debarking p0) (not-boarding p1) (not-debarking p1) (not-boarding p2) (not-debarking p2) (not-boarding p3) (not-debarking p3) (not-boarding p4) (not-debarking p4))
