(define (domain tree_20_3_4)
  ...
  (:action left_18_1
    ...
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db0) (not (noise db1))))))
  )
  (:action left_18_2
    :precondition (and (at L18) (noise db2))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db1) (not (noise db2))))))
  )
  (:action left_18_3
    :precondition (and (at L18) (noise db3))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db2) (not (noise db3))))))
  )
  (:action left_18_4
    :precondition (and (at L18) (noise db4))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db3) (not (noise db4))))))
  )
  (:action left_18_5
    :precondition (and (at L18) (noise db5))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db4) (not (noise db5))))))
  )
  (:action left_18_6
    :precondition (and (at L18) (noise db6))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db5) (not (noise db6))))))
  )
  (:action left_18_7
    :precondition (and (at L18) (noise db7))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db6) (not (noise db7))))))
  )
  (:action left_18_8
    :precondition (and (at L18) (noise db8))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db7) (not (noise db8))))))
  )
  (:action left_18_9
    :precondition (and (at L18) (noise db9))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db8) (not (noise db9))))))
  )
  (:action left_18_10
    :precondition (and (at L18) (noise db10))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db9) (not (noise db10))))))
  )
  (:action left_18_11
    :precondition (and (at L18) (noise db11))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db10) (not (noise db11))))))
  )
  (:action left_18_12
    :precondition (and (at L18) (noise db12))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db11) (not (noise db12))))))
  )
  (:action left_18_13
    :precondition (and (at L18) (noise db13))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db12) (not (noise db13))))))
  )
  (:action left_18_14
    :precondition (and (at L18) (noise db14))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db13) (not (noise db14))))))
  )
  (:action left_18_15
    :precondition (and (at L18) (noise db15))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db14) (not (noise db15))))))
  )
  (:action left_18_16
    :precondition (and (at L18) (noise db16))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db15) (not (noise db16))))))
  )
  (:action left_18_17
    :precondition (and (at L18) (noise db17))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db16) (not (noise db17))))))
  )
  (:action left_18_18
    :precondition (and (at L18) (noise db18))
    :effect (oneof
               (and (at L19) (not (at L18)))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db17) (not (noise db18))))))
  )
  (:action left_19_0
  ...
  (:action left_19_1
    ...
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db0) (not (noise db1))))))
  )
  (:action left_19_2
    :precondition (and (at L19) (noise db2))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db1) (not (noise db2))))))
  )
  (:action left_19_3
    :precondition (and (at L19) (noise db3))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db2) (not (noise db3))))))
  )
  (:action left_19_4
    :precondition (and (at L19) (noise db4))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db3) (not (noise db4))))))
  )
  (:action left_19_5
    :precondition (and (at L19) (noise db5))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db4) (not (noise db5))))))
  )
  (:action left_19_6
    :precondition (and (at L19) (noise db6))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db5) (not (noise db6))))))
  )
  (:action left_19_7
    :precondition (and (at L19) (noise db7))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db6) (not (noise db7))))))
  )
  (:action left_19_8
    :precondition (and (at L19) (noise db8))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db7) (not (noise db8))))))
  )
  (:action left_19_9
    :precondition (and (at L19) (noise db9))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db8) (not (noise db9))))))
  )
  (:action left_19_10
    :precondition (and (at L19) (noise db10))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db9) (not (noise db10))))))
  )
  (:action left_19_11
    :precondition (and (at L19) (noise db11))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db10) (not (noise db11))))))
  )
  (:action left_19_12
    :precondition (and (at L19) (noise db12))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db11) (not (noise db12))))))
  )
  (:action left_19_13
    :precondition (and (at L19) (noise db13))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db12) (not (noise db13))))))
  )
  (:action left_19_14
    :precondition (and (at L19) (noise db14))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db13) (not (noise db14))))))
  )
  (:action left_19_15
    :precondition (and (at L19) (noise db15))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db14) (not (noise db15))))))
  )
  (:action left_19_16
    :precondition (and (at L19) (noise db16))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db15) (not (noise db16))))))
  )
  (:action left_19_17
    :precondition (and (at L19) (noise db17))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db16) (not (noise db17))))))
  )
  (:action left_19_18
    :precondition (and (at L19) (noise db18))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db17) (not (noise db18))))))
  )
  (:action left_19_19
    :precondition (and (at L19) (noise db19))
    :effect (oneof
               (and (at L20) (not (at L19)))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db18) (not (noise db19))))))
  )
  ...
  (:action right_18_1
    :precondition (and (at L18) (noise db1))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db2) (not (noise db1)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db0) (not (noise db1))))))
  )
  (:action right_18_2
    :precondition (and (at L18) (noise db2))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db3) (not (noise db2)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db1) (not (noise db2))))))
  )
  (:action right_18_3
    :precondition (and (at L18) (noise db3))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db4) (not (noise db3)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db2) (not (noise db3))))))
  )
  (:action right_18_4
    :precondition (and (at L18) (noise db4))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db5) (not (noise db4)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db3) (not (noise db4))))))
  )
  (:action right_18_5
    :precondition (and (at L18) (noise db5))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db6) (not (noise db5)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db4) (not (noise db5))))))
  )
  (:action right_18_6
    :precondition (and (at L18) (noise db6))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db7) (not (noise db6)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db5) (not (noise db6))))))
  )
  (:action right_18_7
    :precondition (and (at L18) (noise db7))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db8) (not (noise db7)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db6) (not (noise db7))))))
  )
  (:action right_18_8
    :precondition (and (at L18) (noise db8))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db9) (not (noise db8)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db7) (not (noise db8))))))
  )
  (:action right_18_9
    :precondition (and (at L18) (noise db9))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db10) (not (noise db9)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db8) (not (noise db9))))))
  )
  (:action right_18_10
    :precondition (and (at L18) (noise db10))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db11) (not (noise db10)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db9) (not (noise db10))))))
  )
  (:action right_18_11
    :precondition (and (at L18) (noise db11))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db12) (not (noise db11)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db10) (not (noise db11))))))
  )
  (:action right_18_12
    :precondition (and (at L18) (noise db12))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db13) (not (noise db12)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db11) (not (noise db12))))))
  )
  (:action right_18_13
    :precondition (and (at L18) (noise db13))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db14) (not (noise db13)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db12) (not (noise db13))))))
  )
  (:action right_18_14
    :precondition (and (at L18) (noise db14))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db15) (not (noise db14)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db13) (not (noise db14))))))
  )
  (:action right_18_15
    :precondition (and (at L18) (noise db15))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db16) (not (noise db15)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db14) (not (noise db15))))))
  )
  (:action right_18_16
    :precondition (and (at L18) (noise db16))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db17) (not (noise db16)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db15) (not (noise db16))))))
  )
  (:action right_18_17
    :precondition (and (at L18) (noise db17))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db18) (not (noise db17)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db16) (not (noise db17))))))
  )
  (:action right_18_18
    :precondition (and (at L18) (noise db18))
    :effect (oneof
               (and (at L19) (not (at L18)) (noise db19) (not (noise db18)) (bit L19))
               (and (at L17) (not (at L18)) (when (bit L18) (and (not (bit L18)) (noise db17) (not (noise db18))))))
  )
  (:action right_19_0
    :precondition (and (at L19) (noise db0))
  ...
  (:action right_19_1
    :precondition (and (at L19) (noise db1))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db2) (not (noise db1)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db0) (not (noise db1))))))
  )
  (:action right_19_2
    :precondition (and (at L19) (noise db2))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db3) (not (noise db2)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db1) (not (noise db2))))))
  )
  (:action right_19_3
    :precondition (and (at L19) (noise db3))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db4) (not (noise db3)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db2) (not (noise db3))))))
  )
  (:action right_19_4
    :precondition (and (at L19) (noise db4))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db5) (not (noise db4)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db3) (not (noise db4))))))
  )
  (:action right_19_5
    :precondition (and (at L19) (noise db5))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db6) (not (noise db5)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db4) (not (noise db5))))))
  )
  (:action right_19_6
    :precondition (and (at L19) (noise db6))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db7) (not (noise db6)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db5) (not (noise db6))))))
  )
  (:action right_19_7
    :precondition (and (at L19) (noise db7))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db8) (not (noise db7)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db6) (not (noise db7))))))
  )
  (:action right_19_8
    :precondition (and (at L19) (noise db8))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db9) (not (noise db8)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db7) (not (noise db8))))))
  )
  (:action right_19_9
    :precondition (and (at L19) (noise db9))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db10) (not (noise db9)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db8) (not (noise db9))))))
  )
  (:action right_19_10
    :precondition (and (at L19) (noise db10))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db11) (not (noise db10)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db9) (not (noise db10))))))
  )
  (:action right_19_11
    :precondition (and (at L19) (noise db11))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db12) (not (noise db11)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db10) (not (noise db11))))))
  )
  (:action right_19_12
    :precondition (and (at L19) (noise db12))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db13) (not (noise db12)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db11) (not (noise db12))))))
  )
  (:action right_19_13
    :precondition (and (at L19) (noise db13))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db14) (not (noise db13)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db12) (not (noise db13))))))
  )
  (:action right_19_14
    :precondition (and (at L19) (noise db14))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db15) (not (noise db14)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db13) (not (noise db14))))))
  )
  (:action right_19_15
    :precondition (and (at L19) (noise db15))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db16) (not (noise db15)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db14) (not (noise db15))))))
  )
  (:action right_19_16
    :precondition (and (at L19) (noise db16))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db17) (not (noise db16)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db15) (not (noise db16))))))
  )
  (:action right_19_17
    :precondition (and (at L19) (noise db17))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db18) (not (noise db17)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db16) (not (noise db17))))))
  )
  (:action right_19_18
    :precondition (and (at L19) (noise db18))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db19) (not (noise db18)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db17) (not (noise db18))))))
  )
  (:action right_19_19
    :precondition (and (at L19) (noise db19))
    :effect (oneof
               (and (at L20) (not (at L19)) (noise db20) (not (noise db19)) (bit L20))
               (and (at L18) (not (at L19)) (when (bit L19) (and (not (bit L19)) (noise db18) (not (noise db19))))))
  )
)
