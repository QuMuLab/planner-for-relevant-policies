...
def validate(dfile, pfile, sol, val):
    ...
    while open_list:
        ...
        if not a:
            ...
            # This is a fix for certain circumstances where the action name
            #  is changed by the FD translator to include a version at the end.
            #  This is a hack, but it works for now.
            if a not in actions and a.split('_')[-1][0] == 'v':
