...
TRANSLATOR_REVS = [3827, 3829, 3840, 4283, 4703]
...
def build_planning_exp():
    ...
    #exp.add_resource("PLANNER", os.path.join(main_dir, 'trunk-r3842', 'downward/search/release-search'),
    #                "release-search")
    ...
    for translator_rev in TRANSLATOR_REVS:
        translator = os.path.join(main_dir, 'translate-r%d' % translator_rev, 'translate.py')
