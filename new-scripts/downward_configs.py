...
def raz_ipc():
    return [
        ("mas-1", "--search 'astar(mas(max_states=1,merge_strategy=6,shrink_strategy=shrink_bisimulation(true, false)))'"),
        ("mas-2", "--search 'astar(mas(max_states=200000,merge_strategy=6,shrink_strategy=shrink_dfp(enable_greedy_bisimulation)))'"),
        ]
